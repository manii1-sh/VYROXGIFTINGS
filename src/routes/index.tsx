      ...
      <section ref={sceneRef} className="relative h-[300vh]" aria-label="VYROX campaign introduction">
        <div className="sticky top-0 h-dvh overflow-hidden border-b border-border bg-hero">
          ...
          <div className="absolute inset-0 flex items-center justify-center pt-12">
            ...
            <img src={heroModels} alt="Female and male VYROX models in crimson tailoring" width={1024} height={1536} className="absolute bottom-0 left-1/2 z-30 h-[82vh] w-auto max-w-none -translate-x-1/2 object-contain drop-shadow-hero sm:h-[92vh]" style={{ transform: `translateX(-50%) translateY(${progress * 12}px) scale(${0.94 + progress * 0.06})` }} />
